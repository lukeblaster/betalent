    ...
    >
      <TableHeader className="h2 bg-blue-primary text-white rounded-t-[8px] hover:opacity-100">
        <TableRow className=" *:text-white *:px-regular-16 *:py-litle-8">
          ...
          <TableHead className="text-left w-full">NOME</TableHead>
          <TableHead className="w-[40px] h-[80%] rounded-tr-[8px] text-left">
      ...
      <TableBody className="h3">
        <Disclosure>
          ...
          <DisclosurePanel
            transition
            className=" text-gray-500 border-b border-b-gray-10 origin-top transition duration-150 ease-in ease-out data-[closed]:-translate-y-6 data-[closed]:opacity-0"
            as="td"
            colSpan={3}
          >
